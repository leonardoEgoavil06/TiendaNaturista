    ...
    <body>
        ...
        <%
             ...
             int id = Integer.parseInt(request.getParameter("id"));
               ps = con.prepareStatement("SELECT * FROM productos WHERE idProducto="+id);
               rs = ps.executeQuery();
            ...
            <div class="input-box shadow p-3 mb-5 bg-body rounded">
                <form class="p-3" action="" method="">
                    <div class="input-field mt-5">
                        <input type="text" class="input"  name="id" value="<%= rs.getInt("idProducto") %>" readonly=""/>
                    ...
                    <div class="input-field mt-5">
                        <input type="text" class="input" name="descripcion" value="<%= rs.getString("descripcion") %>"/>
                        <label class="name">Descripción</label> 
                    </div>
                    <div class="input-field mt-5">
                        <input type="text" class="input" name="precio" value="<%= rs.getDouble("precio") %>"/>
                        <label class="name">Precio</label> 
                    </div>
                    <div class="input-field mt-5">
                        <input type="text" class="input" name="stock" value="<%= rs.getInt("stock") %>"/>
...
<%
    String nombre, descripcion,precio,stock;
     ...
     if (nombre!=null && descripcion!=null && precio!=null && stock!=null){
       ps = con.prepareStatement("UPDATE productos SET nombre='"+nombre+"', descripcion='"+descripcion+"' , precio='"+precio+"', stock='"+stock+"' WHERE idProducto="+id);
       ps.executeUpdate();
